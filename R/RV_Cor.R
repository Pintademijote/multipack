...
#'
#' `RV_COR()` Return a correlogram of the uncorrelated metrics of the Chloe analylis.
#'
#' This function is meant to be used with the tab generated by formultivariate()
#' The RV coefficient is meant to computed the correlation between two tabs.
#' In this case metric's values at each scale is considered as tab. So a RV coefficient is computed
#' for each pairwise metrics.
...
#' @return Return a correlogram of the uncorrelated metrics of the Chloe analylis.
#' @export
